...
import { InvestmentFeeImpactCalculator } from "./investment-fee-impact-calculator";

export function LocalizedInvestmentFeeImpactPage({
  locale,
}: {
  ...
  return (
    <main id="main-content" className="flex-1">
      ...
      <div className="mx-auto w-full max-w-[1440px] px-5 py-8 sm:px-6 sm:py-10">
        ...
        <div className="mt-6">
          <InvestmentFeeImpactCalculator locale={locale} />
        </div>
