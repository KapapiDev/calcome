  ...
  return (
    <main id="main-content" className="flex-1">
      ...
      <div className="mx-auto w-full max-w-[1440px] px-5 py-8 sm:px-6 sm:py-10">
        <nav aria-label={ko ? "경로" : "Breadcrumb"} className="text-sm text-muted-foreground">
        ...
        <section className="mt-10 rounded-xl border bg-card p-5">
          <h2 className="text-xl font-semibold">{ko ? "2026년 계산 기준" : "2026 calculation basis"}</h2>
          ...
          <p className="mt-3 text-xs leading-6 text-muted-foreground">{ko ? "기준 확인일: 2026-08-26" : "Verified: Aug 26, 2026"}</p>
          <div className="mt-4 flex flex-wrap gap-3 text-sm">
            <a className="underline underline-offset-4" href="https://www.nts.go.kr/nts/cm/cntnts/cntntsView.do?cntntsId=7862&mi=6583" target="_blank" rel="noreferrer">
              {ko ? "국세청 근로소득 원천징수 안내" : "National Tax Service withholding guide"}
            </a>
            <a className="underline underline-offset-4" href="https://www.law.go.kr/법령/소득세법시행령" target="_blank" rel="noreferrer">
              {ko ? "국가법령정보센터 소득세법 시행령" : "Income Tax Act Enforcement Decree"}
            </a>
          </div>
        </section>
      </div>
