...
import { CryptoProfitLossCalculator } from "./crypto-profit-loss-calculator";

export function LocalizedCryptoProfitLossPage({
  locale,
}: {
  ...
  return (
    <main id="main-content" className="flex-1">
      ...
      <div className="mx-auto w-full max-w-[1440px] px-5 py-8 sm:px-6 sm:py-10">
        ...
        <div className="mt-6">
          <CryptoProfitLossCalculator locale={locale} />
        </div>
        <section className="mt-10 rounded-xl border bg-card p-5">
          ...
          <div className="mt-3 flex flex-wrap gap-3 text-sm">
            <Link
              ...
              href={`/${locale}/finance/crypto-average-cost`}
            >
              {locale === "ko"
                ? "암호화폐 평균단가 계산기"
                : "Cryptocurrency Average Cost Calculator"}
            </Link>
            <Link
              className="underline underline-offset-4"
