    ...
    <main id="main-content" className="flex-1">
      ...
      <div className="mx-auto w-full max-w-[1440px] px-5 py-8 sm:px-6 sm:py-10">
        ...
        <section className="mt-10 rounded-xl border bg-card p-5">
          <h2 className="text-xl font-semibold">{ko ? "계산 기준" : "Calculation basis"}</h2>
          ...
          <div className="mt-4 flex flex-wrap gap-3 text-sm">
            <a className="underline underline-offset-4" href="https://www.nts.go.kr/nts/cm/cntnts/cntntsView.do?cntntsId=7870&mi=6490" target="_blank" rel="noreferrer">
              {ko ? "국세청 연말정산 계산 구조" : "National Tax Service settlement structure"}
            </a>
          </div>
          <h2 className="mt-7 text-xl font-semibold">{ko ? "입력값 찾는 법" : "Where to find the inputs"}</h2>
          <p className="mt-3 text-sm leading-7 text-muted-foreground">
            {ko
