...
export type SavingsGoalErrors = Partial<
  Record<keyof SavingsGoalValues, string>
>;
...
export function validateSavingsGoal(
  ...
  if (targetAmount === null || targetAmount <= 0) {
    errors.targetAmount = positive;
  }
  if (initialSavings === null || initialSavings < 0) {
    errors.initialSavings = nonNegative;
  }
