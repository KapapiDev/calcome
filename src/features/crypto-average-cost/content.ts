...
export const cryptoAverageCostContent = {
  ko: {
    ...
    method: "기존 투자금액과 추가 매수금액을 더한 뒤 총 보유 수량으로 나눠 가중평균 매수가를 계산합니다.",
  ...
  en: {
    ...
    error: "Enter valid nonnegative quantities and prices. Total quantity must be greater than zero.",
    ...
    method: "The calculator adds the existing cost basis to the additional purchase cost and divides the combined cost by the combined quantity.",
