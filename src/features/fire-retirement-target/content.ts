...
export const fireRetirementTargetContent: Record<FireRetirementTargetLocale, Copy> = {
  ko: {
    title: "FIRE 은퇴 목표 계산기",
    description: "월 생활비와 목표 인출률을 기준으로 경제적 자유에 필요한 목표 자산, 현재 부족액, 달성률과 예상 도달 기간을 계산합니다.",
    category: "저축·연금 계산기",
    input: "FIRE 목표 설정",
    ...
    method: "목표 자산은 예상 연 생활비를 입력한 연간 인출률로 나눠 계산합니다. 목표까지의 기간은 현재 자산에 월 투자액을 더하고 입력한 연 수익률을 월 복리로 환산해 최대 100년까지 추정합니다.",
    cautions: "4% 규칙 같은 인출률은 보장 수익률이나 개인별 적정 은퇴율이 아닙니다. 은퇴 기간, 자산배분, 물가, 세금, 시장 하락 시점과 기타 소득원을 함께 고려하세요.",
    metaTitle: "FIRE 은퇴 목표 계산기 | 경제적 자유 목표 자산 계산",
  },
  en: {
    title: "FIRE Retirement Target Calculator",
    description: "Estimate a financial-independence portfolio target, funding gap, progress, and time to goal from spending and a chosen withdrawal rate.",
    ...
    method: "The target portfolio equals estimated annual spending divided by the selected annual withdrawal rate. Time to target compounds the current portfolio at the entered annual return converted to a monthly rate and adds the monthly contribution for up to 100 years.",
    cautions: "A rule of thumb such as 4% is not a guaranteed return or a universally safe withdrawal rate. Consider retirement horizon, asset allocation, inflation, taxes, sequence risk, and other income sources.",
    metaTitle: "FIRE Retirement Target Calculator | Financial Independence Number",
  },
};
