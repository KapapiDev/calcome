...
import { HomeSaleNetProceedsCalculator } from "./home-sale-net-proceeds-calculator";

export function LocalizedHomeSaleNetProceedsPage({
  locale,
}: {
  ...
  return (
    <main id="main-content" className="flex-1">
      ...
      <div className="mx-auto w-full max-w-[1440px] px-5 py-8 sm:px-6 sm:py-10">
        ...
        <div className="mt-6">
          <HomeSaleNetProceedsCalculator locale={locale} />
        </div>
        <section className="mt-10 rounded-xl border bg-card p-5">
          ...
          <div className="mt-3 flex flex-wrap gap-3 text-sm">
            ...
            <Link
              className="underline underline-offset-4"
              href={`/${locale}/finance/capital-gains-tax`}
            >
              {locale === "ko"
                ? "양도소득세 계산기"
