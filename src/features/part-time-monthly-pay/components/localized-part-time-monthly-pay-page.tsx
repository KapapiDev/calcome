...
import { PartTimeMonthlyPayCalculator } from "./part-time-monthly-pay-calculator";

export function LocalizedPartTimeMonthlyPayPage({
  locale,
}: {
  ...
  return (
    <main id="main-content" className="flex-1">
      ...
      <div className="mx-auto w-full max-w-[1440px] px-5 py-8 sm:px-6 sm:py-10">
        ...
        <div className="mt-6">
          <PartTimeMonthlyPayCalculator locale={locale} />
        </div>
        <section className="mt-10 rounded-xl border bg-card p-5">
          ...
          <div className="mt-3 flex flex-wrap gap-3 text-sm">
            <Link
              ...
              href={`/${locale}/employment/weekly-holiday-pay`}
            >
              {locale === "ko"
                ? "주휴수당 계산기"
