...
export const homePurchaseTotalCostCalculator = {
  ...
  name: "주택 매수 총비용 계산기",
  description: "매매가에 취득세, 중개보수, 등기·법무, 대출·감정, 이사·설치, 수리·가구 비용 등을 더해 총매입원가와 필요 자기자금을 계산합니다.",
  keywords: ["주택 매수 비용", "집 살 때 비용", "주택 구입 총비용", "매매 부대비용", "home purchase total cost"],
  category: "금융",
...
export const homeSaleNetProceedsCalculator = {
  ...
  name: "주택 매도 순수익 계산기",
  description: "주택 매도가에서 대출 상환액과 중개보수, 세금, 법무·정산, 수리·이사 등 매도 비용을 빼 예상 순수익을 계산합니다.",
  keywords: ["주택 매도 순수익", "집 팔면 남는 돈", "주택 매도 비용", "매도 정산", "home sale net proceeds"],
  category: "금융",
...
export const rentalYieldCalculator = {
  id: "rental-yield",
  name: "임대수익률 계산기",
  description: "매입가, 월 임대료, 공실률과 연간 운영비를 반영해 총 임대수익률과 순 임대수익률을 계산합니다.",
  keywords: ["임대수익률", "월세 수익률", "부동산 수익률", "NOI", "rental yield"],
  category: "금융",
...
export const apartmentManagementFeeBudgetCalculator = {
  ...
  name: "아파트 관리비 예산 계산기",
  description: "월 관리비·공과금·주차비와 연간 특별부과금을 합쳐 월·연간 관리비 예산과 ㎡당 비용, 소득 대비 비율을 계산합니다.",
  keywords: ["아파트 관리비", "관리비 예산", "관리비 계산기", "평당 관리비", "apartment management fee"],
  category: "금융",
...
export const percentageCalculator = {
  id: "percentage",
  name: "퍼센트 계산기",
  description: "어떤 수의 몇 퍼센트인지, 구성비와 이전 값 대비 증감률을 한 번에 계산합니다.",
  keywords: ["퍼센트 계산기", "비율 계산", "백분율", "증감률", "percentage calculator"],
  category: "금융",
...
export const calculatorDirectoryCategories = base.calculatorDirectoryCategories.map((category) =>
  category.id === "employment"
    ...
    : category.id === "business-life"
      ? { ...category, calculatorIds: [...category.calculatorIds, "employer-total-labor-cost", "percentage"] }
      : category.id === "loan"
        ? { ...category, calculatorIds: [...category.calculatorIds, "jeonse-loan-limit"] }
        : category.id === "housing"
          ? { ...category, calculatorIds: [...category.calculatorIds, "rent-affordability", "jeonse-vs-rent", "home-purchase-total-cost", "home-sale-net-proceeds", "rental-yield", "apartment-management-fee-budget"] }
          : category,
...
export const directorySearchCalculators = [
  ...
  { ...homePurchaseTotalCostCalculator, primaryCategory: "부동산·주거", keywords: [...homePurchaseTotalCostCalculator.keywords, "주택 취득 비용", "집 매수 예산", "부동산 매매 비용", "closing costs"] },
  { ...homeSaleNetProceedsCalculator, primaryCategory: "부동산·주거", keywords: [...homeSaleNetProceedsCalculator.keywords, "매도대금 정산", "주택담보대출 상환", "집 매도 순수익", "seller net proceeds"] },
  { ...rentalYieldCalculator, primaryCategory: "부동산·주거", keywords: [...rentalYieldCalculator.keywords, "임대 수익", "순영업소득", "월세 투자수익률", "gross rental yield", "net rental yield"] },
  { ...apartmentManagementFeeBudgetCalculator, primaryCategory: "부동산·주거", keywords: [...apartmentManagementFeeBudgetCalculator.keywords, "관리비 월평균", "관리비 소득 비율", "㎡당 관리비", "condo fee budget"] },
  { ...percentageCalculator, primaryCategory: "사업·생활", keywords: [...percentageCalculator.keywords, "몇 퍼센트", "퍼센트 증가", "퍼센트 감소", "percent change"] },
