...
- [ ] UX-025 OPEN — Directory English Calculator Name Localization Regression
  - Scope: replace mechanically generated English calculator names in the directory with an explicit source-driven localization contract so visible labels remain natural and stable without changing canonical routes, calculator IDs, inventory count, search behavior, structured-data uniqueness, or Korean copy.
