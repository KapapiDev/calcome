...
- [ ] UX-034 OPEN — Directory English Calculator Search Category Localization Regression
  - Scope: verify English directory search results expose localized English category labels instead of Korean primary-category copy, while preserving canonical routes, ranking semantics, Korean search behavior, and the 100-calculator inventory.
