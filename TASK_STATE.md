...
- [ ] UX-015 OPEN — Directory Category Navigation and Anchor Continuity Regression
  - Scope: verify horizontal category navigation, anchor focus/scroll behavior, active section entry, small-screen overflow, and Korean/English directory continuity remain predictable at the 100-calculator scale without changing canonical calculator routes.
