...
- [ ] UX-016 OPEN — Directory Popular Calculator Locale Parity Regression
  - Scope: verify the Korean popular-calculator shortcut block and the English directory offer equivalent localized discovery, 44px entry targets, stable canonical routes, and predictable placement without duplicating the 100-calculator inventory.
