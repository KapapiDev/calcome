...
- [ ] UX-036 OPEN — Directory English Calculator Search Category Query Regression
  - Scope: verify whether localized English category names should participate in directory search matching at a lower relevance tier than names and aliases, preserving deterministic ranking, Korean search behavior, canonical routes, and the 100-calculator inventory.
