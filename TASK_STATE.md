...
- [ ] UX-037 OPEN — Directory English Calculator Search Category Normalization Consistency Regression
  - Scope: verify localized English category query matching follows the shared NFKC/case-fold/trim normalization contract without changing category ranking tiers, Korean search behavior, canonical routes, or the 100-calculator inventory.
