...
- [ ] UX-014 OPEN — Directory Calculator Card Density and Entry Regression
  - Scope: verify calculator-card information hierarchy, long localized names and category labels, 44px entry targets, 200% zoom, small-screen wrapping, and canonical card routes remain scannable and usable across the 100-calculator Korean and English directories without overflow, route drift, or duplicated inventory.
