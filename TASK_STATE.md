...
- [ ] UX-035 OPEN — Directory English Calculator Search Category Coverage Guard
  - Scope: harden English search category coverage so future directory/category additions cannot ship searchable calculators without an explicit localized category label, while preserving routes, ranking semantics, Korean search behavior, and the 100-calculator inventory.
